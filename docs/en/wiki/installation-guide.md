...
You can download a Lingmo OS image [here](https://lingmo.org/downloads). Make sure to save it to a memorable location on your PC. For this tutorial, we will use Lingmo OS 2.1 which is the latest version.
